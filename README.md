# Dragonfly-Clock-Calculator
A visual calculator for the clock method I made known as Dragonfly

To use:
U, D, C, L, and R refer to their respective pieces, holding shift while holding one of these keys lets you change the back side while just holding the key changes the front.
1, 2, 3, and 4 are UL, UR, DR, and DL respectively where holding shift makes them ur, ul, dl, dr.
